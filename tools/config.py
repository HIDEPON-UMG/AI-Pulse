...
# GPU メモリ占有閾値（MB）。ComfyUI Desktop 等の常駐で VRAM が埋まっている時は local を試さず
# 即 Gemini にフォールバック。RTX5080 16GB のうち 6GB 超を「占有あり」とみなす（35B-A3B は ~12GB 消費）。
HYBRID_GPU_THRESHOLD_FB_MB = 6000
